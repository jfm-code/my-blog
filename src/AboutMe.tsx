...
export const AboutMe = () => {
    return (
        <div className="flex flex-col items-center px-5 custom_sm:px-10 custom_md:px-20 custom_xl:px-40 text-justify text-lg text-primary">
            ...
            <div className="w-full px-20 py-10 space-y-8 relative before:absolute before:inset-0 before:ml-5custom_md:before:mx-auto before:h-full before:w-0.5 before:bg-primary">
