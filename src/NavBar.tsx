const NavBar = () => {
    return (
    <nav className="w-screen px-20 py-10">
      <div className="w-full flex items-center justify-between">
        ...
        <div className="flex flex-row items-center space-x-6 text-[#7c9e83]">
          ...
          <div>
            <input className="px-3 py-1 text-base text-gray-900 border border-2 border-[#7c9e83] focus:border-green-900 outline-none rounded-lg bg-gray-50" type="text" placeholder="Search..."></input>
