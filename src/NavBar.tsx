      ...
      <div className="w-full flex items-center md:justify-between">
        ...
        <div className="w-full md:w-fit flex flex-col">
          <div className="flex flex-row items-center w-full md:w-fit justify-between">
            ...
            <button onClick={()=> handleOpenDropdown()} id="button-hamburger" type="button" className="md:hidden inline-flex items-center justify-center p-2 w-10 h-10 text-sm text-primary rounded-lg hover:bg-primarylight hover:text-primarydark focus:outline-none" aria-controls="navbar-hamburger" aria-expanded="false">
          ...
          {isOpenDropdown && <div id="navbar-hamburger" className="w-full ml-2">
            <div className="flex flex-col font-medium mt-4 rounded-lg bg-gray-50">
