        ...
        <div>
            <div className="flex flex-col items-center px-40 text-justify text-lg text-primary">
                ...
                <div className="flex flex-row space-x-14 items-center">
                    ...
                    <div className="w-1/4">
                        <img className="size-96 rounded-full" src="https://firebasestorage.googleapis.com/v0/b/jfm-blog.appspot.com/o/others%2Foldblogprofilepic.jpg?alt=media&token=2f0e297f-d8a1-41f3-8abf-a42348a88af7"></img>
                    </div>
                </div>
                <p className="self-start text-3xl font-bold text-primarydark">My life in a nutshell</p>
                ...
                <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group">
                        ...
                        <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] bg-white p-4 rounded border border-slate-200 shadow">
                            <div className="flex items-center justify-between space-x-2 mb-1">
                                <div className="font-bold text-primarydark text-xl">Valedictorian, Science & Engineering Competition</div>
                                <time className="font-bold italic text-xl">2019 - 2020</time>
                            </div>
                            <div>
                    ...
                    <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group">
                        ...
                        <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] bg-white p-4 rounded border border-slate-200 shadow">
                            <div className="flex items-center justify-between space-x-2 mb-1">
                                <div className="font-bold text-primarydark text-xl">Coding, Club & Community project participation</div>
                                <time className="font-bold italic text-xl">2021</time>
                            </div>
                            <div>
                    ...
                    <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group">
                        ...
                        <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] bg-white p-4 rounded border border-slate-200 shadow">
                            <div className="flex items-center justify-between space-x-2 mb-1">
                                <div className="font-bold text-primarydark text-xl">Being tutor, Highschool graduation & College in the US</div>
                                <time className="font-bold italic text-xl">2022</time>
                            </div>
                            <div>
                    ...
                    <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group">
                        ...
                        <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] bg-white p-4 rounded border border-slate-200 shadow">
                            <div className="flex items-center justify-between space-x-2 mb-1">
                                <div className="font-bold text-primarydark text-xl">12 books, Gym & Part-time job in the US</div>
                                <time className="font-bold italic text-xl">2023</time>
                            </div>
                            <div>
                    ...
                    <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group">
                        ...
                        <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] bg-white p-4 rounded border border-slate-200 shadow">
                            <div className="flex items-center justify-between space-x-2 mb-1">
                                <div className="font-bold text-primarydark text-xl">Have a balance lifestyle & First internship</div>
                                <time className="font-bold italic text-xl">2024</time>
                            </div>
                            <div>- Quit tutoring job after almost 3 years to start my first internship.
                                <br></br>
