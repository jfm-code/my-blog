...
export const Post = () => {  
    ...
    return (
        <div className="flex flex-col items-center px-5 custom_sm:px-10 custom_md:px-20 custom_xl:px-40 text-justify text-lg text-primary">
            ...
            <div className="w-full flex flex-col flex-auto mb-10 pt-5 custom_lg:flex-row custom_lg:space-x-10 custom_lg:my-10">
                <div className="flex flex-col mb-5 mx-14 custom_lg:mx-0 custom_lg:mb-0">
                    <p className="flex self-center custom_lg:self-start text-2xl font-semibold mb-2 ml-2">TOPICS</p>
                    <div className="w-full custom_lg:w-1/6 flex justify-start flex-wrap custom_lg:flex-col">
                        {topics.map(topic => (
                            <div className="flex items-center ml-4 min-w-52">
