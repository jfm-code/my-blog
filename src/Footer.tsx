export const Footer = () => {
    return (
        <div className="flex flex-row justify-around bg-primary text-lg sm:text-xl text-primary px-5 md:px-20 xl:px-40">
            ...
            <div className="flex flex-col my-8 lg:my-14 space-y-3 hidden lg:block">
            ...
            <form className="pl-3 sm:pl-0 my-8 lg:my-14 space-y-8">
                <p className="text-white font-bold">SUBSCRIBE FOR EMAILS FROM JFM BLOG</p>
                <div className="space-y-1">
                    <p className="text-white">Full name</p>
                    <input className="px-3 py-1 text-white w-72 sm:w-80 bg-primary border border-white border-0 border-b outline-none focus:text-primary focus:bg-white focus:shadow-lg"></input>
                </div>
                <div className="space-y-1">
